...
import {Info, MessageSquare, Plus, Rocket, Satellite, Globe, Sparkles, ChevronDown, Zap, Shield, Database } from 'lucide-react';
...
const {darkMode, toggleTheme} = useTheme();
  ...
  return (
    ...
    h-auto
    overflow-y-auto
    scrollbar-hide transition-colors duration-500  ${darkMode ? 'bg-gray-900' : 'bg-gray-300'}`}>
